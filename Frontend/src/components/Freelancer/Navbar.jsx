...
const Navbar = () => {
  ...
  <div className="relative flex max-w-screen-xl flex-col overflow-hidden px-4 py-4 md:mx-auto md:flex-row md:items-center">
    ...
    <label className="absolute top-5 right-7 cursor-pointer md:hidden" for="navbar-open">
      ...
      <svg href="https://res.cloudinary.com/dgvslio7u/image/upload/v1722411107/tyqao18fdxtj7pefzc3n.png" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
