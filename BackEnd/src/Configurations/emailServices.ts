        ...
        <body style="font-family: Arial, sans-serif; color: #333; padding: 20px; background-color: #f4f4f4;">
          <div style="max-width: 600px; margin: auto; padding: 20px; background: #ffffff; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
            <div style="text-align: center; margin-bottom: 30px;">
              <img src="https://res.cloudinary.com/dgvslio7u/image/upload/v1722411107/tyqao18fdxtj7pefzc3n.png" alt="FlexiWork Logo" style="max-width: 150px; margin-bottom: 20px;" />
            </div>
            <h1 style="color: #007bff; text-align: center; margin-bottom: 30px;">Welcome to FlexiWork!</h1>
            ...
            <p style="font-size: 16px; line-height: 1.5; text-align: center; border-top: 1px solid #f4f4f4; padding-top: 20px;">Best regards,<br><strong>The FlexiWork Team</strong></p>
          </div>
        </body>
      </html>
    `,
